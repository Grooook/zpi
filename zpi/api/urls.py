...
urlpatterns = [
    ...
    path('get_applications/', ShortApplicationListView.as_view(),
    ...
    path('user/application/<int:id>/',
         UserApplicationCreateView.as_view(), name='user-application'),
    path('user_applications/', UserApplicationsListListView.as_view(),
