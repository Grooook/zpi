...
urlpatterns = [
                  ...
                  path('create_new_application/', ApplicationCreateView.as_view(), name='create_new_application'),
                  ...
                  path('create_user_application/<int:id>/', UserApplicationCreateView.as_view(), name='create_user_application'),

                  path('user_applications/', UserApplicationListView.as_view(), name='user_applications'),
