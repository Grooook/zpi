        ...
        <div className="d-flex">
          {(() => {
            if (isUserAuthenticated()) {
              return (
                <div className="d-flex">
                  <a className="nav-link active" aria-current="page" href="#">{t("All applications")}</a>
                  <a className="nav-link active" aria-current="page" href="#">{t("My applications")}</a>
                  <a href="#" onClick={logout} className="nav-link active" aria-current="page">{t("Logout")}</a>
                </div>
              )
            } else {
              return (
